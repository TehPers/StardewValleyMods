...
namespace TehPers.Core.Api.DependencyInjection.Syntax
{
    ...
    internal class WithEventsBindingToSyntax<T1, T2, T3> : WithEventsBindingToSyntax, IBindingToSyntax<T1, T2, T3>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WithEventsBindingToSyntax{T1, T2, T3}"/> class.
        /// </summary>
        ...
        public WithEventsBindingToSyntax(IProxyBindable root, IKernel kernel, IBindingConfiguration bindingConfiguration)
            : base(root, kernel, bindingConfiguration, typeof(T1), typeof(T2), typeof(T3))
        {
        }
