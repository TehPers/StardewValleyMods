...
namespace TehPers.Core.Api.DependencyInjection.Syntax
{
    ...
    /// <typeparam name="T3">The third service being bound.</typeparam>
    /// <typeparam name="T4">The fourth service being bound.</typeparam>
    internal class WithEventsBindingToSyntax<T1, T2, T3, T4> : WithEventsBindingToSyntax, IBindingToSyntax<T1, T2, T3, T4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WithEventsBindingToSyntax{T1, T2, T3, T4}"/> class.
        /// </summary>
        ...
        public WithEventsBindingToSyntax(IProxyBindable root, IKernel kernel, IBindingConfiguration bindingConfiguration)
            : base(root, kernel, bindingConfiguration, typeof(T1), typeof(T2), typeof(T3), typeof(T4))
        {
        }
