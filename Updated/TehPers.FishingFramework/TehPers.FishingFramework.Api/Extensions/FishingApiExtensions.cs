...
namespace TehPers.FishingFramework.Api.Extensions
{
    ...
    public static class FishingApiExtensions
    {
        ...
        /// <param name="waterTypes">The type of water being fished in.</param>
        ...
        public static IEnumerable<IWeightedValue<T>> WhereAvailable<T>(this IEnumerable<T> items, Farmer who, GameLocation location, Weathers weather, WaterTypes waterTypes, SDateTime dateTime, int? mineLevel = null)
            where T : IFishingAvailability
        {
            ...
            return items
                .ToWeighted(item => item.GetWeightedChance(who, location, weather, waterTypes, dateTime, mineLevel))
        ...
        public static WaterTypes GetWaterType(this GameLocation location, Vector2 tileLocation)
        {
            _ = location ?? throw new ArgumentNullException(nameof(location));
