...
namespace TehPers.CoreMod.Api.Items.Machines {
    public readonly struct Recipe {
        ...
        /// <param name="heldObject">The <see cref="SObject"/> being held by the farmer.</param>
        ...
        public bool GetHeldRequests(SObject heldObject, out IEnumerable<ObjectRequest> requests) {
            ...
            if (heldIngredient != null) {
                ...
                requests = (from ingredient in this.Input
                            ...
                            select new ObjectRequest(new SObject(Vector2.Zero, ingredient.Index(), ingredient.Quantity)))
        ...
        public IEnumerable<ObjectRequest> GetRequests() {
            return this.Input.Select(ingredient => new ObjectRequest(new SObject(Vector2.Zero, ingredient.Index(), ingredient.Quantity)));
        }
