...
namespace System {
	public partial struct ValueTuple {
		...
		internal static int CombineHashes(int h1) {
			return h1 ^ ValueTuple.CombineHashes();
		}
		...
		internal static int CombineHashes(int h1, int h2) {
			return h2 ^ ValueTuple.CombineHashes(h1);
		}
		...
		internal static int CombineHashes(int h1, int h2, int h3) {
			return h3 ^ ValueTuple.CombineHashes(h1, h2);
		}
		...
		internal static int CombineHashes(int h1, int h2, int h3, int h4) {
			return h4 ^ ValueTuple.CombineHashes(h1, h2, h3);
		}
		...
		internal static int CombineHashes(int h1, int h2, int h3, int h4, int h5) {
			return h5 ^ ValueTuple.CombineHashes(h1, h2, h3, h4);
		}
		...
		internal static int CombineHashes(int h1, int h2, int h3, int h4, int h5, int h6) {
			return h6 ^ ValueTuple.CombineHashes(h1, h2, h3, h4, h5);
		}
		...
		internal static int CombineHashes(int h1, int h2, int h3, int h4, int h5, int h6, int h7) {
			return h7 ^ ValueTuple.CombineHashes(h1, h2, h3, h4, h5, h6);
		}

		internal static int CombineHashes(int h1, int h2, int h3, int h4, int h5, int h6, int h7, int h8) {
			return h8 ^ ValueTuple.CombineHashes(h1, h2, h3, h4, h5, h6, h7);
		}
		internal static ValueTuple<T1, T2, T3, T4, T5, T6, T7, ValueTuple<T8>> Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, T8 item8) {
